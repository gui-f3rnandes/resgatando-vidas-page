...
function Location() {
  return (
    <section id="locations" className="w-full overflow-hidden">
      ...
      <div
        id="locationsCards"
        className="flex flex-col justify-center items-center px-4 w-[55vw] md:w-[60vw] max-sm:w-[90vw] mx-auto my-16 pb-16"
      >
        <div className="grid grid-cols-1 xl:grid-cols-2 gap-6 md:gap-10 w-full">
          <CardOfClinics
            imageSrc={"../assets/unidade-de-acolhimento.png"}
            clinicName="Unidade AP"
            description={
              "Atendimento completo com enfermeiras, cuidadores, psiquiatras, assistentes sociais etc."
            }
            address="Itaperica da Serra - SP"
            className="w-full h-full"
          />
          <CardOfClinics
            imageSrc={"../assets/almeida-barros.png"}
            clinicName="Almeida Barros"
            description={
              "Unidade masculina de alto padrão com equipe técnica, barbearia, nutricionista e cozinheiros."
            }
            address="Pouso Alegre - SP"
            className="w-full h-full"
          />
          <CardOfClinics
            imageSrc={"../assets/anjos-de-deus.png"}
            clinicName="Anjos de Deus"
            description={
              "Unidade masculina de alto padrão com equipe técnica, métodos especializados e estutura de ponta."
            }
            address="Itú - SP"
            className="w-full h-full"
          />
          <CardOfClinics
            imageSrc={"../assets/valents.png"}
            clinicName="Valent's"
            description={
              "Unidade feminina com segurança absoluta, boas acomodações e plano terapêutico completo."
            }
