...
function TypeService() {
    return (
        <section className="bg-[#C9A871] flex flex-col justify-center items-center p-20 py-40 gap-10" id="servicos">
            ...
            <div className="flex flex-col xl:flex-row xl:w-[70vw] gap-y-10 md:space-x-5">
                <TPSCards srcImage={"../assets/voluntaria.jpeg"} type={'Internação voluntária'}
                    itemsIn={[
                        {
        ...
        <TPSCards
          srcImage={"../assets/involuntaria.jpg"}
          type={"Internação involuntária"}
          itemsIn={[
            {
        ...
        <TPSCards
          srcImage={"../assets/psiquiatrica.jpg"}
          type={"Internação psiquiátrica"}
          itemsIn={[
            {
